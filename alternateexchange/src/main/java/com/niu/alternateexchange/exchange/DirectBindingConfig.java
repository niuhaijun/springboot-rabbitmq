...
public class DirectBindingConfig {
  ...
  public static final String ROUTING_KEY_B = "AlternateDirectExchange to queueB";
  ...
  public Binding directBindingTwo(
      @Qualifier(DirectExchangeConfig.ALTERNATE_DIRECT_EXCHANGE) DirectExchange exchange,
